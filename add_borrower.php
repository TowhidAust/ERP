...
<head>
	...
	<link rel="stylesheet" href="assets/css/BorrowCss/borrow.css">
				...
				<div class="col-md-12">
					<form role="form" class="form-horizontal form-groups-bordered">
						<div class="form-group">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" id="field-A" placeholder="Enter borrower's name">
							</div>
						</div>
						<div class="form-group">
							<label for="field-1" class="col-sm-3 control-label">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" id="field-A" placeholder="Enter borrower's father/husband name">
							</div>
						</div>
						<div class="form-group">
							<label for="field-1" class="col-sm-3 control-label">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" id="field-A" placeholder="Enter borrower's address">
							</div>
						</div>
						<div class="form-group">
							<label for="field-1" class="col-sm-3 control-label">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" id="field-A" placeholder="Enter borrower's Phone Number">
							</div>
						</div>
						<div class="form-group">
							<label for="field-1" class="col-sm-3 control-label">
